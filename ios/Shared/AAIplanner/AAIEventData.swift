...
//      "Authoring Visual Analytics Using Amazon QuickSight",
   ...
   // TODO add real data to the trainings
    static let eventSequences: [String: [(name: String, duration: Int)]] = [
      ...
      "Architecting on AWS": [
         ("AoA - Welcome", 20),
         ("AoA - Module 0: Course Introduction", 5),
         ("AoA - Module 1: Introduction to Amazon Web Services", 30),
         ("AoA - Module 2: Compute in the Cloud (Part 1)", 30),
         ("AoA - ☕️🍎 Break", 15),
         ("AoA - Module 2: Compute in the Cloud (Part 2)", 30),
         ("AoA - Module 3: Global Infrastructure and Reliability", 25),
         ("AoA - Module 4: Networking (Part 1)", 20),
         ("AoA - 🍴🍲🥝 Lunch", 60),
         ("nextDay", 1),
         ("AoA - Module 5: Storage and Databases", 40),
         ("AoA - Module 6: Security", 35),
         ("AoA - ☕️🍎 Break", 10),
         ("AoA - Module 7: Monitoring and Analytics", 20),
         ("AoA - Module 8: Pricing and Support", 30),
         ("AoA - Module 9: Migration and Innovation", 40),
         ("AoA - Module 10: AWS Certified Cloud Practitioner Basics", 15),
         ("AoA - 🙋‍♀️❓🙋‍♂️ Q&A", 30),
      ],
